...
namespace Terrain
{
    ...
    public:
        ...
        // backBufferFormat: Format of the render target
        ...
        // Crater deformation methods
        void InitializeCraterMap(ID3D12Device* device, ID3D12GraphicsCommandList* cmdList, UINT width, UINT height);
        void DispatchCraterDeformation(ID3D12GraphicsCommandList* cmdList,
    ...
    private:
        ...
        UploadBuffer<CraterParams>* mCraterParamsCB = nullptr;
        Microsoft::WRL::ComPtr<ID3D12DescriptorHeap> mUavHeap;
        UINT mCraterMapWidth = 0;
        UINT mCraterMapHeight = 0;
        bool mCraterMapNeedsTransitionToUAV = false;  // Track resource state for proper transitions
