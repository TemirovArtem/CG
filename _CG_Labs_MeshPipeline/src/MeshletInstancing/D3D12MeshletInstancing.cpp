...
void D3D12MeshletInstancing::OnMouseMove(int x, int y, bool leftButtonDown)
{
    m_camera.OnMouseMove(x, y, leftButtonDown);
}

void D3D12MeshletInstancing::OnMouseDown(int button, int x, int y)
{
    m_camera.OnMouseDown(button, x, y);
}

void D3D12MeshletInstancing::OnMouseUp(int button, int x, int y)
{
