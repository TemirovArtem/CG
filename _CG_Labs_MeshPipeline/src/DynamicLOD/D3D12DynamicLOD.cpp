...
void D3D12DynamicLOD::OnMouseMove(int x, int y, bool leftButtonDown)
{
    m_camera.OnMouseMove(x, y, leftButtonDown);
}

void D3D12DynamicLOD::OnMouseDown(int button, int x, int y)
{
    m_camera.OnMouseDown(button, x, y);
}

void D3D12DynamicLOD::OnMouseUp(int button, int x, int y)
{
