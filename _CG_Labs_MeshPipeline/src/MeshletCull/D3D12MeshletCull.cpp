...
void D3D12MeshletCull::OnMouseMove(int x, int y, bool leftButtonDown)
{
    m_mainCam.OnMouseMove(x, y, leftButtonDown);
}

void D3D12MeshletCull::OnMouseDown(int button, int x, int y)
{
    m_mainCam.OnMouseDown(button, x, y);
}

void D3D12MeshletCull::OnMouseUp(int button, int x, int y)
{
    m_mainCam.OnMouseUp(button, x, y);
}
